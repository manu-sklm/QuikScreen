...
//Inngest Fucntion to cancel booking and release seats of show after 10 mints of booking created, if payment is not made
 ...
 const releaseSeatsAndDeleteBooking=inngest.createFunction(
  ...
  async ({event,step})=>{
          ...
          await step.run('check-payment-status',async()=>{
            ...
            //if payment is not made ,realese seasts and delete booking
